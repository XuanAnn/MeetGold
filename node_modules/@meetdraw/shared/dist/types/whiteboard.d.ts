export type ToolType = 'select' | 'pan' | 'pen' | 'highlighter' | 'line' | 'rect' | 'circle' | 'text' | 'sticky' | 'eraser';
export type WhiteboardEventType = 'CREATE' | 'UPDATE' | 'DELETE' | 'CLEAR' | 'UNDO' | 'REDO' | 'CURSOR' | 'INIT_SYNC';
